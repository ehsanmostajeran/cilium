...
import (
	...
	"github.com/cilium-team/cilium/Godeps/_workspace/src/github.com/docker/engine-api/types/network"
	"github.com/cilium-team/cilium/Godeps/_workspace/src/github.com/docker/engine-api/types/registry"
...
type Container struct {
	...
	NetworkSettings *SummaryNetworkSettings `json:",omitempty"`
}
...
type Info struct {
	...
	ExecutionDriver    string                  `json:",omitempty"`
	LoggingDriver      string                  `json:",omitempty"`
	...
	NCPU               int                     `json:",omitempty"`
	MemTotal           int64                   `json:",omitempty"`
...
type ContainerJSONBase struct {
	...
	ProcessLabel    string                `json:",omitempty"`
...
type NetworkConnect struct {
	Container      string                    `json:",omitempty"`
	EndpointConfig *network.EndpointSettings `json:"endpoint_config,omitempty"`
}
